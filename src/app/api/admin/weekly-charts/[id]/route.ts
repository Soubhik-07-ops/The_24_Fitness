// src/app/api/admin/weekly-charts/[id]/route.ts
...
// PUT: Update a weekly chart (admin)
export async function PUT(
    ...
    try {
        ...
        // Verify that this chart was created by admin (created_by IS NULL)
...
// DELETE: Delete a weekly chart (admin)
